<div class="chats index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('person1'); ?></th>
			<th><?php echo $this->Paginator->sort('person2'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($chat['Chat']['person1']); ?>&nbsp;</td>
		<td><?php echo h($chat['Chat']['person2']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $chat['Chat']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $chat['Chat']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
